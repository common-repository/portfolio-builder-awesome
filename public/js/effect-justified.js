...
;(function(window) {
	...
	function GridLoaderFx(el, options) {
		this.el = el;
		this.items = this.el.querySelectorAll('.justify-item .justify-inner > .item-wrap');
	}
	...
	// 	grids = [].slice.call(document.querySelectorAll('.grid-template')), masonry = [],
	// 	currentGrid = 0,
